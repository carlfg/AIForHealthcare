...
def Dice3d(a, b):
    ...
    print(f"Dice calc: intersection{intersection} volume A:{np.sum(a)} volume B: {np.sum(b)}")
...
def Jaccard3d(a, b):
    ...
    print(f"Jaccard calc: intersection{intersection} volume A:{np.sum(a)} volume B: {np.sum(b)}")
